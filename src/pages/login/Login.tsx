...
export const Login = () => {
  ...
  return (
    <Container>
      <section className="bg-gray-50 dark:bg-gray-900 mt-25 rounded-2xl">
        <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:grid sm:grid-cols-2 xl:p-0 dark:bg-gray-800 dark:border-gray-700">
